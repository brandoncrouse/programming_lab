...
//this script is from Trevor Mock's "How to Recreate Madeline's Hair Movement from Celeste" video
public class HairAnchor : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        hairSprites = GetComponentsInChildren<SpriteRenderer>();
    }
    ...
    private void Update()
    {
        ...
        {
            //make sure we're not including the hair anchor, only the parts
